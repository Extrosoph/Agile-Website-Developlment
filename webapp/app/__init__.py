...
from app.views import home_bp, user_bp, statistics_bp, assessment_bp, getValue_bp, setQuestions_bp
...
app.register_blueprint(getValue_bp)
app.register_blueprint(setQuestions_bp)